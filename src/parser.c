...
enum ts_symbol_identifiers {
  ...
  sym_puzzle_name = 36,
  sym_puzzle_type = 37,
  aux_sym__puzzle_definition_section_repeat1 = 38,
  aux_sym_positions_repeat1 = 39,
  aux_sym_algorithm_repeat1 = 40,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_algorithm, 1, 0, 0),
  [33] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_algorithm, 1, 0, 0),
  [35] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__puzzle_definition_section_repeat1, 2, 0, 0), SHIFT_REPEAT(29),
  [38] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__puzzle_definition_section_repeat1, 2, 0, 0),
  [40] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_algorithm_repeat1, 2, 0, 0),
  [42] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_algorithm_repeat1, 2, 0, 0), SHIFT_REPEAT(28),
  [45] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_algorithm_repeat1, 2, 0, 0),
  [47] = {.entry = {.count = 1, .reusable = false}}, SHIFT(29),
  [49] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__puzzle_definition_section, 2, 0, 0),
  [51] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_algorithm_repeat1, 2, 0, 0), SHIFT_REPEAT(27),
  ...
  [62] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_positions_repeat1, 2, 0, 0), SHIFT_REPEAT(30),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_positions_repeat1, 2, 0, 0),
  [67] = {.entry = {.count = 1, .reusable = true}}, SHIFT(28),
  [69] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_positions_repeat1, 2, 0, 0), SHIFT_REPEAT(40),
  ...
  [82] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_positions_repeat1, 2, 0, 0), SHIFT_REPEAT(32),
  ...
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__instructions, 2, 0, 0),
  [95] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__instructions, 2, 0, 0), SHIFT_REPEAT(57),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_move, 1, 0, 0),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_move, 1, 0, 0),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_puzzle_name, 1, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_position, 1, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_position, 1, 0, 0),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_puzzle_type, 1, 0, 0),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_halt_instruction, 2, 0, 4),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_instruction, 2, 0, 0),
  [114] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [116] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_solved_goto_instruction, 3, 0, 5),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_repeat_until_instruction, 5, 0, 6),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_input_instruction, 5, 0, 7),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_print_instruction, 5, 0, 8),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_halt_instruction, 6, 0, 9),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_goto_instruction, 2, 0, 3),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_puzzle_definition, 3, 0, 1),
  [132] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 3, 0, 2),
