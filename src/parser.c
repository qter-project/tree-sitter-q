...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [35] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_algorithm_repeat1, 2, 0, 0), SHIFT_REPEAT(27),
  ...
  [60] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__instructions, 2, 0, 0), SHIFT_REPEAT(52),
  ...
  [86] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_positions_repeat1, 2, 0, 0), SHIFT_REPEAT(38),
  [89] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__puzzle_definition_section_repeat1, 2, 0, 0), SHIFT_REPEAT(41),
  ...
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_move, 1, 0, 0),
  ...
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 3, 0, 2),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_instruction, 2, 0, 0),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_puzzle_definition, 3, 0, 1),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_solved_goto_instruction, 3, 0, 5),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_goto_instruction, 2, 0, 3),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_repeat_until_instruction, 5, 0, 6),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_halt_instruction, 6, 0, 9),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_print_instruction, 5, 0, 8),
